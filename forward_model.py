...
class ForwardModel(object):
    ...
    def forward(self, input, reuse=False, gru_used = True):
        with tf.variable_scope('forward_model'):
            ...
            if gru_used == True:
                ...
                state_embedder2 = ops.dense(state_embedder1, self.encoding_size, self.encoding_size, tf.sigmoid, "encoder2_state", reuse)
